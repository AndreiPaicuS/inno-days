    ...
    return (
        <div className="p-4">
            ...
            <button
                ...
                className={`mb-4 px-4 py-2 ${!skillName.trim() ? 'bg-gray-500' : isEditing ? 'bg-yellow-500' : 'bg-blue-500'} text-white rounded hover:${!skillName.trim() ? 'bg-gray-500' : isEditing ? 'bg-yellow-700' : 'bg-blue-700'}`}
            >
